...
class KubusImageHavingPage extends StatefulWidget {
  const KubusImageHavingPage({super.key});

  @override
  State<KubusImageHavingPage> createState() => _KubusImageHavingPageState();
}

class _KubusImageHavingPageState extends State<KubusImageHavingPage> {
      ...
      child: Column(
        children: [
          ...
          CustomMaterialBubble(
            heading: 'IMAGE HAVING',
            content: Column(
              children: [
                Text(
                  'Apa maksud dari “volume” menurutmu setelah melihat melakukan kegiatan di atas?',
