...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    final uid = context.read<PageProvider>().answers.id;
    context.read<UserBloc>().add(GetUserById(uid));
  }
    ...
    return BlocListener<UserBloc, UserState>(
      listener: (context, state) {
        if (state is GetUserByIdSuccessState) {
          context.read<PageProvider>().setUser(state.user);
      ...
      child: Consumer<PageProvider>(
        builder: (context, pageProvider, child) {
          ...
          int userLevel = pageProvider.answers.userLevel;
          int kubusLevel = pageProvider.answers.kubusLevel;
          int balokLevel = pageProvider.answers.balokLevel;
          ...
          List<Widget> pageList = [
            ...
            kubusBalokEvaluasi(
              context,
              context.read<PageProvider>().answers.isPretest,
