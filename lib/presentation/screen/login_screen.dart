                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty == true) {
                        ...
                        if (passwordController.text == _userList[0].classCode ||
                            (passwordController.text == adminPass && isAdmin)) {
                          return null;
                        } else {
                    ...
                    onTap: () {
                      if (formKey.currentState!.validate()) {
                        if (username == usernameController.text) {
                          ...
                          final bool isPretest = userSp.getBool('isPretest')!;
                          ...
                          context.read<PageProvider>().setUserLevel(userLevel);
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                isAdmin ? AdminCheckDataScreen() : HomeScreen(),
                          ),
                        );
                      }
                    },
